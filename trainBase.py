...
torch.save(LMC_model.state_dict() , "modelsBase/lmc.pt")
torch.save(MC_model.state_dict()  , "modelsBase/mc.pt")
torch.save(MLMC_model.state_dict(), "modelsBase/mlmc.pt")
...
plt.savefig("figsBase/LMC_train_loss")
plt.clf()
plt.plot(LMC_test_loss)
plt.savefig("figsBase/LMC_test_loss")
plt.clf()
plt.plot(LMC_train_accuracy)
plt.savefig("figsBase/LMC_train_accuracy")
plt.clf()
plt.plot(LMC_test_accuracy) 
plt.savefig("figsBase/LMC_test_accuracy")
plt.clf()

# MLMC
plt.plot(MLMC_train_loss)
plt.savefig("figsBase/MLMC_train_loss")
plt.clf()
plt.plot(MLMC_test_loss)
plt.savefig("figsBase/MLMC_test_loss")
plt.clf()
plt.plot(MLMC_train_accuracy)
plt.savefig("figsBase/MLMC_train_accuracy")
plt.clf()
plt.plot(MLMC_test_accuracy)
plt.savefig("figsBase/MLMC_test_accuracy")
plt.clf()

# MC
plt.plot(MC_train_loss)
plt.savefig("figsBase/MC_train_loss")
plt.clf()
plt.plot(MC_test_loss)
plt.savefig("figsBase/MC_test_loss")
plt.clf()
plt.plot(MC_train_accuracy)
plt.savefig("figsBase/MC_train_accuracy")
plt.clf()
plt.plot(MC_test_accuracy)
plt.savefig("figsBase/MC_test_accuracy")
plt.clf()
#endregion Plotting
